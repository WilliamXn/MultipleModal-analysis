...
def record_data(video_folder: str, hop_length: int):
...
extract_audio("video/C/C_1.mp4", "D:\PycharmProjects\pythonProject\MultipleModal\\video\C\C_1.mp3")
df = record_data("video/C", 512)
print(analyse())